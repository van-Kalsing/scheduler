function render_linear_calendar(container_element) {
    container_element.html("<button style='position: absolute; left: 540px; top: 120px; height: 240px; weight: 50' onclick='this.style.left=parseInt(this.style.left)+43+'px'; tabulate(Tasks, ['T1']);'>+</button>");
